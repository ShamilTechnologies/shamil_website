...
class AppLocalizations {
  ...
  // Helper method to keep track of current locale
  ...
  String plural(String key, int count) {
    final String pluralKey = count == 1 ? '${key}_one' : '${key}_other';
    return _localizedStrings[pluralKey]?.replaceAll('%d', count.toString()) 
      ?? _localizedStrings[key]?.replaceAll('%d', count.toString()) 
      ?? key;
  }
}
